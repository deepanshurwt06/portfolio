...
export default function HomeContent() {
  ...
  return (
    <div className="flex flex-col gap-2 md:gap-3 lg:gap-4 px-7   lg:pl-20">
      <h1 className="text-3xl md:text-4xl lg:6xl font-bold text-slate-300 ">
        Hi, I&apos;m{" "}
      </h1>
      <h1 className="text-3xl font-bold text-slate-300 md:text-4xl lg:6xl">
        Deepanshu Rawat
      </h1>
      ...
      <p className="text-md font-medium text-gray-400 md:text-xl lg:text-lg max-w-4xl">
        ...
        impactful solutions and turning ideas into real-world sollutions, while
        continuously exploring new technologies.
      </p>

      <div className="flex gap-8 md:gap-12 lg:gap-16 mt-6">
        <a
          href="https://drive.google.com/file/d/144YFqq7a4I8f0PHvghCsykFqDRSFF_Ci/view?usp=sharing" // or external link like "https://yourdomain.com/resume.pdf"
          target="_blank"
        ...
        <Button
          ...
          className="relative overflow-hidden bg-[#000010] text-[#4cc9f0] font-semibold px-8 py-2 border border-[#4cc9f0] transition-all duration-500 group md:px-10 md:py-4 md:text-xl  md:font-bold lg:px-14 lg:py-6 lg:text-xl lg:font-semibold"
        >
      ...
      <div className="flex flex-row gap-6 md:gap-9 lg:gap-12 mt-4 md:mt-5  p-2">
        ...
        <div className="h-11 w-11 md:h-13 md:w-13 lg:h-14 lg:w-14 rounded-full  border-2 border-[#4cc9f0] flex justify-center items-center relative overflow-hidden transition-all duration-500 group">
          ...
          <a
            href="https://www.linkedin.com/in/deepanshurwt6/"
            target="_blank"
            title="Linkedin"
            rel="noopener noreferrer"
          >
        ...
        <div className="h-11 w-11 md:h-13 md:w-13 lg:h-14 lg:w-14 rounded-full  border-2 border-[#4cc9f0] flex justify-center items-center relative overflow-hidden transition-all duration-500 group">
          ...
          <a
            href="https://www.instagram.com/rwt_deepanshu__?igsh=MTJuNzZ6MWY3ZjR4MA=="
            target="_blank"
            title="Instagram"
            rel="noopener noreferrer"
          >
